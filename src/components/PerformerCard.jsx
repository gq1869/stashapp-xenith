  ...
  return (
    <div className={`hon-scene-card tier-${tier.toLowerCase()} ${outcomeClass}`} data-side={side}>
      ...
      <div className="hon-card-native-wrap" onClickCapture={handleNativeCardClick}>
        {NativePerformerCard ? (
          <NativePerformerCard performer={item} />
        ) : (
      ...
      <button type="button" className="hon-choose-btn" onClick={onChoose}>✓ Choose This Performer</button>
    </div>
  );
}
